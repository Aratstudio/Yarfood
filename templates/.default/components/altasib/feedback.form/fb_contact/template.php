...
<div class="afbf alx_feed_back row d-flex <? $arParams['INPUT_APPEARENCE'] != 'DEFAULT' ? strtolower($arParams['INPUT_APPEARENCE']) : '' ?>"
     id="alx_feed_back_<?= $ALX ?>">
    <? else: ?>
    <div class="<? foreach ($arParams['INPUT_APPEARENCE'] as $param) if ($param != 'DEFAULT') echo strtolower($param) . ' ' ?>"
         id="alx_feed_back_<?= $ALX ?>">
        <? endif ?>
        <?
        ?>

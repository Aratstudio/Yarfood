            ...
            <div class="col-lg-7 col-12 mb-50">
                ...
                <div class="single-product-content">
                    ...
                    <div class="single-product-description">
						...
						<span class="availability">Доступность: <span><?=($arResult['CAN_BUY'] ? 'В наличии' : 'Нет в наличии')?></span></span>
						<?=($arResult['CAN_BUY'] ? '' : '<p class="non-availabe">Данный товар отсутствует на складе в Красноярске. Доставка под заказ в течение 7 - 14 дней</p>')?>

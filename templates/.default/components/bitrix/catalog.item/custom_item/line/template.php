		...
		<div class="right-content">
			<div class="specification">
 				...
 				<p class="availability"><?
                    	if($item['CAN_BUY'] ? 'В наличии' : 'Под заказ');
				...
				if( !empty($item['PROPERTIES']['PROIZVODITEL']['VALUE']) ) {
					echo "<li>Производитель: " . $item['PROPERTIES']['PROIZVODITEL']['VALUE'] . "</li>";
				}
				if( !empty($item['PROPERTIES']['GLUBINA_MM']['VALUE']) ) {
					echo "<li>Глубина: " . $item['PROPERTIES']['GLUBINA_MM']['VALUE'] . " мм.</li>";
				}
				if( !empty($item['PROPERTIES']['SHIRINA_MM_5']['VALUE']) ) {
					echo "<li>Ширина: " . $item['PROPERTIES']['SHIRINA_MM_5']['VALUE'] . "мм.</li>";
				}
				if( !empty($item['PROPERTIES']['VYSOTA_MM']['VALUE']) ) {
					echo "<li>Высота: " . $item['PROPERTIES']['VYSOTA_MM']['VALUE'] . " мм.</li>";
				}
				if( !empty($item['PROPERTIES']['CML2_ARTICLE']['VALUE']) ) {
					echo "<li>Артикул: " . $item['PROPERTIES']['CML2_ARTICLE']['VALUE'] . "</li>";
				}
				?>

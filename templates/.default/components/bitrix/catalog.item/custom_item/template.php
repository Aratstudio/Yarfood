...
if (isset($arResult['ITEM']))
{
	...
	?>
	<div class="col-xl-<?=($arResult['TYPE'] == 'LINE' ? '12' : '3')?> col-md-<?=($arResult['TYPE'] == 'LINE' ? '12' : '6')?> col-12 pb-30 pt-10"
		id="<?=$areaId?>" data-entity="item">
		<? 
		//if($arResult['ITEM']['PROPERTIES']['PROIZVODITEL']['VALUE']=="Rational"){
							//$item['SORT']=1000;
		//			$arResult['ITEM']['SORT']=5;
		//			echo("AAAAAAAAAAAAA");
		//	}

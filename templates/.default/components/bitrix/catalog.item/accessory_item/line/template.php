...
<div class="shop-product-wrap list with-sidebar row">               
	<div class="col-xl-4 col-md-6 col-12 pb-30 pt-10">
		<div class="ee-product">
	
			<div class="image">

				<a href="<?=$item['DETAIL_PAGE_URL']?>" class="img"><img src="<?=$item['PREVIEW_PICTURE']['SRC']?>" alt="Product Image"></a>
			...
			<div class="content">
				...
				<div class="price-ratting">
					...
					<h5 class="price"><?=$item['MIN_PRICE']['PRINT_VALUE']?></h5>
					<div class="ratting">
		...
		<div class="ee-product-list">
			...
			<div class="content">
				...
				<div class="right-content">
					...
					<span class="availability">Доступность444: <span><?=($item['CAN_BUY'] ? 'В наличии' : 'Нет в наличии')?></span></span>
				</div>

...
<div class="catalog-section bx-<?=$arParams['TEMPLATE_THEME']?> shop-product-wrap with-sidebar row <?=(isset($arParams["VIEW_TYPE"]) ? ($arParams["VIEW_TYPE"] == 'LINE' ? 'list' : 'grid') : 'list')?>" data-entity="<?=$containerName?>">
	
	<?//d($arResult)?>
	<?
		$menuID = 918;
	?>
	<?if($arResult["IBLOCK_SECTION_ID"] == $menuID || $arResult["ID"] == $menuID):?>
		<div class="col-xs-12">
			<div class="row">
	
				<?$APPLICATION->IncludeComponent(
				"bitrix:catalog.section.list",
				"mx_sections_zapchasti",
				Array(
										...
										$APPLICATION->IncludeComponent(
											...
											array(
												'RESULT' => array(
													'ITEM' => $item,
													'AREA_ID' => $areaIds[$item['ID']],
													'TYPE' => $arParams["VIEW_TYPE"] ? $arParams["VIEW_TYPE"] : $rowData['TYPE'],
													'BIG_LABEL' => 'N',
													'BIG_DISCOUNT_PERCENT' => 'N',
													'BIG_BUTTONS' => 'N'
												),
...
{
	?>
	<div class="catalog-desc bx-section-desc bx-<?=$arParams['TEMPLATE_THEME']?>">

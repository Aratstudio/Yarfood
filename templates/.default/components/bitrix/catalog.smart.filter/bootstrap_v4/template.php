	...
	<form name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get">
		...
		<?foreach($arResult["ITEMS"] as $key=>$arItem)//prices
		{
			...
			if(isset($arItem["PRICE"])):
				...
				<div class="shop-sidebar mb-35 smart-filter-parameters-box bx-active">
					<span class="smart-filter-container-modef"></span>

					<h4 class="title"><?=$arItem["NAME"]?></h4>

					<div class="smart-filter-block sf-price-slider-block" data-role="bx_filter_block">
		...
		foreach($arResult["ITEMS"] as $key=>$arItem)
		{
			...
			<div class="shop-sidebar mb-35 smart-filter-parameters-box <?if ($arItem["DISPLAY_EXPANDED"]== "Y"):?>bx-active<?endif?>">
				<span class="smart-filter-container-modef"></span>

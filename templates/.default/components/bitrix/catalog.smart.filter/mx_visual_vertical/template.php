...
?>
<div class="mb-35 bx_filter <?=$templateData["TEMPLATE_CLASS"]?>">
			...
			foreach($arResult["ITEMS"] as $key=>$arItem)
			{
				...
				if(isset($arItem["PRICE"])):
					...
					<div class="bx_filter_parameters_box active">
						...
						<div class="bx_filter_parameters_box_title" onclick="smartFilter.hideFilterProps(this)"><span><?=$arItem["NAME"]?></span></div>
						<div class="bx_filter_block">
							<div class="bx_filter_parameters_box_container">
								<div class="bx_filter_parameters_box_container_block">
									<span class="bx_filter_input_container-pricetitlemin">От </span>
								...
								<div class="bx_filter_parameters_box_container_block">
									<span class="bx_filter_input_container-pricetitlemax">До </span>
									<div class="bx_filter_input_container">
										<input
											class="max-price"
											type="text"

    ...
    <div class="container">
        <div class="row">
            <div class="col-12 mb-40">
                <div class="section-title-one" data-title="RELATED PRODUCT"><h1>С этим товаром обычно покупают</h1></div>
            </div>
            <div class="col-12">
                        ...
                        <div class="col pb-20 pt-10">
                            ...
                            <div class="ee-product">
                                ...
                                <div class="image">
                                    ...
                                    <a href="<?=$item['DETAIL_PAGE_URL']?>" class="img"><img src="<?=$item['PREVIEW_PICTURE']['SRC']?>" alt="<?=$item['NAME']?>"></a>
                                ...
                                <div class="content">
                                    ...
                                    <div class="category-title">
                                        ...
                                        <a href="#" class="cat"><?=$item['SECTION_NAME']?></a>
                                        <h5 class="title"><a href="<?=$item['DETAIL_PAGE_URL']?>"><?=$item['NAME']?></a></h5>

                                        <p  class="cat article">Артикул: 9047180</p>
                                        <p class="cat availability"><span class="availabe">Товар на складе</span></p>
                                    </div>

                                    <!-- Price & Ratting -->
                                    <div class="price-ratting">

                                        <h5 class="price">15 000 <span class="rub">₽</span></h5>

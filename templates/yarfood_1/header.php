...
<noscript><div><img src="https://mc.yandex.ru/watch/63229558" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
<!-- /Yandex.Metrika counter -->
...
<?if($USER->IsAdmin()):?>
		<style>
			...
			#bx-panel.vis {display:block !important;}
			.fixedBitrixPanel {position:fixed; z-index:1000000000; width:100%;}
			.fixedBitrixPanel .showPanel {background:scroll #4A525B url(/bitrix/js/main/core/images/panel/top-panel-sprite-2.png) repeat-x 0 0 !important; height:25px; padding:0 10px; font: normal normal bold 12px/25px "Helvetica Neue", Helvetica, Arial, sans-serif !important; color: #DDE7E9 !important; cursor:pointer; display:inline-block; border-radius:0 0 10px 10px; left:50%; margin-left:-40px; position:absolute; top:100%;}
			.fixedBitrixPanel .showPanel:hover {background:scroll rgba(0, 0, 0, 0) url(/bitrix/js/main/core/images/panel/top-panel-sprite-2.png) 0 -1173px !important;}
		</style>
	<?endif;?>		
<?
$showPanel = false;
$userGroup = $USER -> GetUserGroupArray();
$serializeGroup = COption::GetOptionString("main", "show_panel_for_users");
$group = unserialize($serializeGroup);
foreach($userGroup as $val){				
	if(in_array("G".$val,$group)){
		$showPanel = true;
		break;
	}
}
if($USER->IsAdmin() || $showPanel):?>
	<div class="fixedBitrixPanel">
		<?$APPLICATION -> ShowPanel()?>
		<div class="showPanel">
			<div>Панель управления</div>
			<div style="display:none;">Скрыть панель</div>
		</div>
		<script>
			$(document).ready(function(){
				$('.showPanel').click(function(){
					$('#bx-panel').toggleClass('vis');
					$('.showPanel div').toggle();
				});
			})
		</script>
	</div>
...
<div class="header-section">
    ...
    <div class="header-top header-top-two header-top-border pt-10 pb-10">
        <div class="container">
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col order-12 order-xs-12 order-md-2 mt-10 mb-10 ml-auto mx_mobile">
	...
	<div class="header-sticky1 main-head1 relative">
		<div class="container relative blue-bg1">
			...
			<a href="" class="header__top__hamburger closed">
						<span class="header__top__hamburger__closed">
							<svg width="18" height="16" viewBox="0 0 18 16" fill="none" xmlns="http://www.w3.org/2000/svg">
								<path d="M0 0H18V2H0V0Z" fill="#000"/>
								<path d="M0 7H18V9H0V7Z" fill="#000"/>
								<path d="M18 14H0V16H18V14Z" fill="#000"/>
							</svg>
						</span>
						<span class="header__top__hamburger__opened">
							<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
								<rect y="1.41422" width="2" height="26" transform="rotate(-45 0 1.41422)" fill="#000"/>
								<rect x="1.41406" y="19.799" width="2" height="26" transform="rotate(-135 1.41406 19.799)" fill="#000"/>
							</svg>
						</span>
					</a>

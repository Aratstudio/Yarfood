...
<div class="product-slider-wrap product-slider-arrow-two" data-entity="<?=$containerName?>">
	<div class="product-slider product-slider-3" data-entity="items-row">
	<?
	if (!empty($arResult['ITEMS']) && !empty($arResult['ITEM_ROWS']))
	{
		...
		foreach ($arResult['ITEM_ROWS'] as $rowData)
		{
			...
			?>
			<div class="col pb-20 pt-10" data-entity="items-row1">
				<?
